...
@implementation SCFollowingTableViewCell
...
//    [self.btnFollowing setFrame:CGRectMake(self.bounds.size.width - 100, 0, 100, 40)];
//    [self.btnFollowing setBackgroundColor:[UIColor greenColor]];

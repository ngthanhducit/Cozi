...
@implementation SCFollowingTableView
...
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SCFollowingTableViewCell *scCell = nil;
    
    scCell = (SCFollowingTableViewCell*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if (scCell == nil) {
        scCell = [[SCFollowingTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
    ...
    if (follower.userID != storeIns.user.userID) {
        BOOL isFollowing = [storeIns isFollowing:follower.userID];
